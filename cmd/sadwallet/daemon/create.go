...
import (
	...
	"github.com/sadnetwork/sad/cmd/sadwallet/libsadwallet/bip32"
...
func create(conf *createConfig) error {
	...
	fmt.Printf("Notice the above is neither a secret key to your wallet " +
		"(use \"sadwallet dump-unencrypted-data\" to see a secret seed phrase) " +
		"nor a wallet public address (use \"sadwallet new-address\" to create and see one)\n\n")
	...
	if len(signerExtendedPublicKeys) > 0 {
		cosignerIndex, err = libsadwallet.MinimumCosignerIndex(signerExtendedPublicKeys, extendedPublicKeys)
		if err != nil {
			return err
		}
	}
