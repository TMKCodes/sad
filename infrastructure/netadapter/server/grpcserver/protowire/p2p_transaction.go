...
func (x *SadMessage_Transaction) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "SadMessage_Transaction is nil")
	}
	return x.Transaction.toAppMessage()
}

func (x *SadMessage_Transaction) fromAppMessage(msgTx *appmessage.MsgTx) error {
