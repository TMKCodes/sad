...
func (x *SadMessage_Version) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "SadMessage_Version is nil")
	}
...
func (x *SadMessage_Version) fromAppMessage(msgVersion *appmessage.MsgVersion) error {
