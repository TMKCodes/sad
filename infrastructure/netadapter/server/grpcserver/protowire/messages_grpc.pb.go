...
type P2P_MessageStreamClient interface {
	Send(*SadMessage) error
	Recv() (*SadMessage, error)
	grpc.ClientStream
}
...
func (x *p2PMessageStreamClient) Send(m *SadMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*SadMessage, error) {
	m := new(SadMessage)
...
func (x *p2PMessageStreamServer) Send(m *SadMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*SadMessage, error) {
	m := new(SadMessage)
...
func (x *rPCMessageStreamClient) Send(m *SadMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*SadMessage, error) {
	m := new(SadMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *rPCMessageStreamServer) Send(m *SadMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*SadMessage, error) {
	m := new(SadMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
