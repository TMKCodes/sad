...
// installService attempts to install the sad Service. Typically this should
...
// removeService attempts to uninstall the sad Service. Typically this should
...
// startService attempts to Start the sad Service.
