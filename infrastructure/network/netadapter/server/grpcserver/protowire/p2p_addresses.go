...
func (x *SadMessage_Addresses) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "SadMessage_Addresses is nil")
	}
...
func (x *SadMessage_Addresses) fromAppMessage(msgAddresses *appmessage.MsgAddresses) error {
