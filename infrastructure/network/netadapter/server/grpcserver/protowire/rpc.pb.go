...
type GetBlockTemplateResponseMessage struct {
	...
	// Whether Sad thinks that it's synced.
	// Callers are discouraged (but not forbidden) from solving blocks when Sad is not synced.
	// That is because when Sad isn't in sync with the rest of the network there's a high
...
type GetConnectedPeerInfoMessage struct {
	...
	// Whether this Sad initiated the connection
	...
	// The timestamp of when this peer connected to this Sad
