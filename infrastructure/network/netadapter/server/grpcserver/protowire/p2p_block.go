...
func (x *SadMessage_Block) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "SadMessage_Block is nil")
	}
	return x.Block.toAppMessage()
}

func (x *SadMessage_Block) fromAppMessage(msgBlock *appmessage.MsgBlock) error {
