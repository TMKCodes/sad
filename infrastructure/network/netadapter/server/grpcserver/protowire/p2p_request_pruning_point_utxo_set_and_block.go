...
func (x *SadMessage_RequestPruningPointUTXOSet) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "SadMessage_RequestPruningPointUTXOSet is nil")
	}
...
func (x *SadMessage_RequestPruningPointUTXOSet) fromAppMessage(
