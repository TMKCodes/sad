...
type grpcStream interface {
	Send(*protowire.SadMessage) error
	Recv() (*protowire.SadMessage, error)
}
...
func (c *gRPCConnection) receive() (*protowire.SadMessage, error) {
...
func (c *gRPCConnection) send(message *protowire.SadMessage) error {
