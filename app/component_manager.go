...
import (
	...
	"github.com/sadnetwork/sad/app/protocol"
	"github.com/sadnetwork/sad/app/rpc"
	"github.com/sadnetwork/sad/domain"
	"github.com/sadnetwork/sad/domain/consensus"
	"github.com/sadnetwork/sad/domain/utxoindex"
	...
	"github.com/sadnetwork/sad/infrastructure/network/addressmanager"
	"github.com/sadnetwork/sad/infrastructure/network/connmanager"
	"github.com/sadnetwork/sad/infrastructure/network/netadapter"
	"github.com/sadnetwork/sad/infrastructure/network/netadapter/id"
	"github.com/sadnetwork/sad/util/panics"
)

// ComponentManager is a wrapper for all the sad Services
...
// Start launches all the sad Services.
...
// Stop gracefully shuts down all the sad Services.
func (a *ComponentManager) Stop() {
	// Make sure this only happens once.
	if atomic.AddInt32(&a.shutdown, 1) != 1 {
		log.Infof("sad is already in the process of shutting down")
		return
	}

	log.Warnf("sad shutting down")
