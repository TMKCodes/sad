...
import (
	...
	"github.com/sadnetwork/sad/infrastructure/os/execenv"
	"github.com/sadnetwork/sad/infrastructure/os/limits"
	"github.com/sadnetwork/sad/infrastructure/os/signal"
	"github.com/sadnetwork/sad/infrastructure/os/winservice"
...
var serviceDescription = &winservice.ServiceDescription{
	Name:        "sadsvc",
	DisplayName: "sad Service",
	Description: "Downloads and stays synchronized with the sad blockDAG and " +
...
// StartApp starts the sad app, and blocks until it finishes running
func StartApp() error {
...
func (app *sadApp) main(startedChan chan<- struct{}) error {
	...
	if err != nil {
		log.Errorf("Unable to start sad: %+v", err)
		return err
	}

	defer func() {
		log.Infof("Gracefully shutting down sad...")
		...
		log.Infof("sad shutdown complete")
	}()
