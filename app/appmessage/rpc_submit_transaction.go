...
// RPCTransaction is a sad transaction representation meant to be
// used over RPC
...
// RPCTransactionInput is a sad transaction input representation
...
// RPCScriptPublicKey is a sad ScriptPublicKey representation
type RPCScriptPublicKey struct {
	Version uint16
	Script  string
}

// RPCTransactionOutput is a sad transaction output representation
// meant to be used over RPC
...
// RPCOutpoint is a sad outpoint representation meant to be used
// over RPC
...
// RPCUTXOEntry is a sad utxo entry representation meant to be used
// over RPC
