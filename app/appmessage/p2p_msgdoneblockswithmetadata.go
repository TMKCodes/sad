...
// MsgDoneBlocksWithTrustedData implements the Message interface and represents a sad
...
// NewMsgDoneBlocksWithTrustedData returns a new sad DoneBlocksWithTrustedData message that conforms to the
// Message interface.
