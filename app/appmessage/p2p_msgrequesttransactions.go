...
// MsgRequestTransactions implements the Message interface and represents a sad
...
// NewMsgRequestTransactions returns a new sad RequestTransactions message that conforms to
