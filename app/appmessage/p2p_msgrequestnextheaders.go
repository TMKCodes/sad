...
// MsgRequestNextHeaders implements the Message interface and represents a sad
...
// NewMsgRequestNextHeaders returns a new sad RequestNextHeaders message that conforms to the
// Message interface.
