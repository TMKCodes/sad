...
// MsgIBDChainBlockLocator implements the Message interface and represents a sad
...
// NewMsgIBDChainBlockLocator returns a new sad locator message that conforms to
