...
var DefaultUserAgent = fmt.Sprintf("/sad:%s/", version.Version())

// MsgVersion implements the Message interface and represents a sad version
...
// NewMsgVersion returns a new sad version message that conforms to the
