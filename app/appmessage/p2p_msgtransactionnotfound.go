...
// MsgTransactionNotFound defines a sad TransactionNotFound message which is sent in response to
...
// NewMsgTransactionNotFound returns a new sad transactionsnotfound message that conforms to the
