...
// MsgRequestAnticone implements the Message interface and represents a sad
...
// NewMsgRequestAnticone returns a new sad RequestPastDiff message that conforms to the
