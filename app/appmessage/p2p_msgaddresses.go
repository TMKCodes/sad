...
// sad Addresses message (MsgAddresses).
const MaxAddressesPerMsg = 1000

// MsgAddresses implements the Message interface and represents a sad
// Addresses message.
...
// NewMsgAddresses returns a new sad Addresses message that conforms to the
