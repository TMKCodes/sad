...
// MsgRequestRelayBlocks implements the Message interface and represents a sad
...
// NewMsgRequestRelayBlocks returns a new sad RequestRelayBlocks message that conforms to
