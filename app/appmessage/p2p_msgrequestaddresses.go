...
// MsgRequestAddresses implements the Message interface and represents a sad
...
// NewMsgRequestAddresses returns a new sad RequestAddresses message that conforms to the
