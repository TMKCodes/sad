...
// MsgRequestHeaders implements the Message interface and represents a sad
...
// NewMsgRequstHeaders returns a new sad RequestHeaders message that conforms to the
