/*
Package txscript implements the sad transaction script language.

This package provides data structures and functions to parse and execute
sad transaction scripts.

# Script Overview

sad transaction scripts are written in a stack-base, FORTH-like language.

The sad script language consists of a number of opcodes which fall into
...
Typical sad scripts at the time of this writing are of several standard
...
what conditions must be met in order to spend sad.
