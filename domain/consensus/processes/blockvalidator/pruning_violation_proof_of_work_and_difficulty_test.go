...
import (
	...
	"github.com/sadnetwork/sad/domain/consensus/utils/blockheader"
	...
	"github.com/sadnetwork/sad/domain/consensus/utils/merkle"
...
func TestPOW(t *testing.T) {
	...
	testutils.ForAllNets(t, false, func(t *testing.T, consensusConfig *consensus.Config) {
		...
		if consensusConfig.Name != "sad-mainnet" {
