...
import (
	...
	"github.com/sadnetwork/sad/domain/consensus/utils/virtual"
...
func (v *blockValidator) checkCoinbaseSubsidy(
	...
	for _, parent := range parents {
		...
		// The pruning proof ( https://github.com/sadnetwork/docs/blob/main/Reference/prunality/Prunality.pdf ) concludes
