...
const (
	...
	defaultSubsidyGenesisReward                    = 1 * constants.SeepPerSad
	defaultPreDeflationaryPhaseBaseSubsidy         = 500 * constants.SeepPerSad
	defaultDeflationaryPhaseBaseSubsidy            = 440 * constants.SeepPerSad
