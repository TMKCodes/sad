...
import (
	...
	"github.com/sadnetwork/sad/util/network"
...
// Params defines a sad network by its parameters. These parameters may be
// used by sad applications to differentiate networks as well as addresses
...
type Params struct {
	...
	// Further details: https://hashdag.medium.com/sad-launch-plan-9a63f4d754a6
	...
	// PruningProofM is the 'm' constant in the pruning proof. For more details see: https://github.com/sadnetwork/research/issues/3
...
// MainnetParams defines the network parameters for the main sad network.
var MainnetParams = Params{
	...
	DefaultPort: "46005",
	DNSSeeds: []string{
		"sad-seed-1.sadcoin.com",
		"sad-seed-2.sadcoin.com",
		"sad-seed-3.sadcoin.com",
	},
...
// TestnetParams defines the network parameters for the test sad network.
var TestnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixSadTest,
...
// SimnetParams defines the network parameters for the simulation test sad
...
var SimnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixSadSim,
...
// DevnetParams defines the network parameters for the development sad network.
var DevnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixSadDev,
...
// ErrDuplicateNet describes an error where the parameters for a sad
// network could not be set due to the network already being a standard
// network or previously-registered into this package.
var ErrDuplicateNet = errors.New("duplicate sad network")

var registeredNets = make(map[appmessage.SadNet]struct{})

// Register registers the network parameters for a sad network. This may
