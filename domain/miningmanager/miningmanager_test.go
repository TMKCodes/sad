...
import (
	...
	"github.com/sadnetwork/sad/domain/consensusreference"
	"github.com/sadnetwork/sad/domain/miningmanager/model"
	...
	"github.com/sadnetwork/sad/domain/consensus/utils/transactionhelper"
	"github.com/sadnetwork/sad/domain/consensus/utils/txscript"
	"github.com/sadnetwork/sad/domain/consensus/utils/utxo"
	"github.com/sadnetwork/sad/domain/miningmanager"
...
func generateNewCoinbase(addressPrefix util.Bech32Prefix, op opType) (*externalapi.DomainCoinbaseData, error) {
	...
	_, publicKey, err := libsadwallet.CreateKeyPair(op == opECDSA)
	if err != nil {
		return nil, err
	}
	var address string
