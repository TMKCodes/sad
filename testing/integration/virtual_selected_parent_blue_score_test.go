...
func TestVirtualSelectedParentBlueScoreAndVirtualDAAScore(t *testing.T) {
	...
	response, err := sad.rpcClient.GetVirtualSelectedParentBlueScore()
	if err != nil {
	...
	err = sad.rpcClient.RegisterForVirtualSelectedParentBlueScoreChangedNotifications(
	...
	err = sad.rpcClient.RegisterForVirtualDaaScoreChangedNotifications(
