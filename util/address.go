...
import (
	...
	"github.com/sadnetwork/sad/util/bech32"
)
...
var stringsToBech32Prefixes = map[string]Bech32Prefix{
	"sad":     Bech32PrefixSad,
	"saddev":  Bech32PrefixSadDev,
	"sadtest": Bech32PrefixSadTest,
	"sadsim":  Bech32PrefixSadSim,
}
...
// and a payload which encodes the sad network and address type. It is used
